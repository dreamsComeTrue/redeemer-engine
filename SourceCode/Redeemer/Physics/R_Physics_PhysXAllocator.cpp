...
#include "R_Physics_PhysXAllocator.h"
...
#define USE_MUTEX 1
		...
		C_PhysXAllocator::C_PhysXAllocator() :
		mNbAllocatedBytes(0),
			mHighWaterMark(0),
			mTotalNbAllocs(0),
			mNbAllocs(0),
		...
		void* C_PhysXAllocator::malloc(NxU32 size)
		{
#ifdef _DEBUG
		...
		void* C_PhysXAllocator::malloc(NxU32 size, NxMemoryType type)
		{
			//	return ::malloc(size);
		...
		void* C_PhysXAllocator::mallocDEBUG(NxU32 size, const char* file, int line)
		{
			printf("Obsolete code called!\n");
			return NULL;
		}

		void* C_PhysXAllocator::mallocDEBUG(NxU32 size, const char* file, int line, const char* className, NxMemoryType type)
		{
#ifdef _DEBUG
		...
		void* C_PhysXAllocator::realloc(void* memory, NxU32 size)
		{
		...
		void C_PhysXAllocator::free(void* memory)
		{
			//	::free(memory);	return;
