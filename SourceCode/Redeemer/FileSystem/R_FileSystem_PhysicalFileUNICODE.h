...
**
**	R_FileSystem_PhysicalFile.h
**		Physical file is raw file stored on a disk
*/

//------------------------------------------------------------------------------------------------------------------------
#ifndef _R_FILESYSTEM_PHYSICALFILEUNICODE_H_
#define _R_FILESYSTEM_PHYSICALFILEUNICODE_H_
...
namespace REDEEMER
{
	...
	{	 	
		/*!
		**	\brief C_PhysicalFileUNICODE is an implementation of raw file stored on a disk
		*/
		class C_PhysicalFileUNICODE : public IDataFile
		{
		public:
			/*!	Default constructor. 
			*/
			C_PhysicalFileUNICODE();
			...
			*/
			C_PhysicalFileUNICODE (const std::wstring& fileName, DWORD mode);

			/*!	Copy constructor.
			*/
			C_PhysicalFileUNICODE (const C_PhysicalFileUNICODE& src);

			/*!	Assignment operator.
			*/
			C_PhysicalFileUNICODE& operator= (const C_PhysicalFileUNICODE& rhs);

			/*!  Default destructor. 
			*/
			virtual ~C_PhysicalFileUNICODE ();
		...
		private:		
			...
			std::wfstream	*m_File;	///<	Wide stream
...
#endif	//	_R_FILESYSTEM_PHYSICALFILEUNICODE_H_
